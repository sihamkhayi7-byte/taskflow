...
export default function Login() {
  ...
  // Détermine où aller après le login (par défaut vers /dashboard)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Utilisation d'Axios pour chercher l'utilisateur
      ...
      // On retire le mot de passe avant de stocker l'utilisateur dans le state
